...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/TEAM-WAD/Files_WAAD/main/File_Bot/commands.lua") 
...
os.execute('wget https://raw.githubusercontent.com/TEAM-WAD/WAAD/main/WAAD.lua')
...
if DevWAADW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/TEAM-WAD/Files_WAAD/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/TEAM-WAD/Files_WAAD/main/File_Bot/"..file)
if res == 200 then
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,WAAD)
local t = "\n*ツ قائمة الاعضاء* \n*◐•━━━━━━ 𝗪𝗔 ━━━━━━━•◐*\n"
x = 0
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'وعد').." غادر" or text == 'غادر' then  
...
if text == 'العاب اونلاين' and Special(msg) then  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙎𝙤𝙪𝙧𝘾𝙚 𝙍𝙤𝙡𝙚𝙭',url="t.me/nnnnBn"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌗ ⁃  مشاࢪڪه .', callback_data="http://t.me/test118bot?startgroup=new"}},
{{text = '‹ ѕᴏụʀᴄᴇ : ᴡᴀᴀᴅ ›.',url="t.me/nnnnBn"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice='..URL.escape(audios.info)..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == '/aa' or text == '/ali' or text == '/start' or text == '/pop' then  
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/OsKaTeAm&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == '⌗ ⁃ حزوࢪه‍  .' or text == 'حزوره' thenif database:get(bot_id..'Lock:Games'..msg.chat_id_) thendatabase:del(bot_id..'Set:Hzora'..msg.chat_id_)Hzora = {'الجرس','عقرب الساعه','السمك','المطر','5','الكتاب','البسمار','7','الكعبه','بيت الشعر','لهانه','انا','امي','الابره','الساعه','22','غلط','كم الساعه','البيتنجان','البيض','المرايه','الضوء','الهواء','الضل','العمر','القلم','المشط','الحفره','البحر','الثلج','الاسفنج','الصوت','بلم'};name = Hzora[math.random(#Hzora)]database:set(bot_id..'Klam:Hzor'..msg.chat_id_,name)name = string.gsub(name,'الجرس','شيئ اذا لمسته صرخ ما هوه ؟')name = string.gsub(name,'عقرب الساعه','اخوان لا يستطيعان تمضيه اكثر من دقيقه معا فما هما ؟')name = string.gsub(name,'السمك','ما هو الحيوان الذي لم يصعد الى سفينة نوح عليه السلام ؟')name = string.gsub(name,'المطر','شيئ يسقط على رأسك من الاعلى ولا يجرحك فما هو ؟')name = string.gsub(name,'5','ما العدد الذي اذا ضربته بنفسه واضفت عليه 5 يصبح ثلاثين ')name = string.gsub(name,'الكتاب','ما الشيئ الذي له اوراق وليس له جذور ؟')name = string.gsub(name,'البسمار','ما هو الشيئ الذي لا يمشي الا بالضرب ؟')name = string.gsub(name,'7','عائله مؤلفه من 6 بنات واخ لكل منهن .فكم عدد افراد العائله ')name = string.gsub(name,'الكعبه','ما هو الشيئ الموجود وسط مكة ؟')name = string.gsub(name,'بيت الشعر','ما هو البيت الذي ليس فيه ابواب ولا نوافذ ؟ ')name = string.gsub(name,'لهانه','وحده حلوه ومغروره تلبس مية تنوره .من هيه ؟ ')name = string.gsub(name,'انا','ابن امك وابن ابيك وليس باختك ولا باخيك فمن يكون ؟')name = string.gsub(name,'امي','اخت خالك وليست خالتك من تكون ؟ ')name = string.gsub(name,'الابره','ما هو الشيئ الذي كلما خطا خطوه فقد شيئا من ذيله ؟ ')name = string.gsub(name,'الساعه','ما هو الشيئ الذي يقول الصدق ولكنه اذا جاع كذب ؟')name = string.gsub(name,'22','كم مره ينطبق عقربا الساعه على بعضهما في اليوم الواحد ')name = string.gsub(name,'غلط','ما هي الكلمه الوحيده التي تلفض غلط دائما ؟ ')name = string.gsub(name,'كم الساعه','ما هو السؤال الذي تختلف اجابته دائما ؟')name = string.gsub(name,'البيتنجان','جسم اسود وقلب ابيض وراس اخظر فما هو ؟')name = string.gsub(name,'البيض','ماهو الشيئ الذي اسمه على لونه ؟')name = string.gsub(name,'المرايه','ارى كل شيئ من دون عيون من اكون ؟ ')name = string.gsub(name,'الضوء','ما هو الشيئ الذي يخترق الزجاج ولا يكسره ؟')name = string.gsub(name,'الهواء','ما هو الشيئ الذي يسير امامك ولا تراه ؟')name = string.gsub(name,'الضل','ما هو الشيئ الذي يلاحقك اينما تذهب ؟ ')name = string.gsub(name,'العمر','ما هو الشيء الذي كلما طال قصر ؟ ')name = string.gsub(name,'القلم','ما هو الشيئ الذي يكتب ولا يقرأ ؟')name = string.gsub(name,'المشط','له أسنان ولا يعض ما هو ؟ ')name = string.gsub(name,'الحفره','ما هو الشيئ اذا أخذنا منه ازداد وكبر ؟')name = string.gsub(name,'البحر','ما هو الشيئ الذي يرفع اثقال ولا يقدر يرفع مسمار ؟')name = string.gsub(name,'الثلج','انا ابن الماء فان تركوني في الماء مت فمن انا ؟')name = string.gsub(name,'الاسفنج','كلي ثقوب ومع ذالك احفض الماء فمن اكون ؟')name = string.gsub(name,'الصوت','اسير بلا رجلين ولا ادخل الا بالاذنين فمن انا ؟')name = string.gsub(name,'بلم','حامل ومحمول نصف ناشف ونصف مبلول فمن اكون ؟ ')send(msg.chat_id_, msg.id_,' *✺↜ اسرع واحد يحل الحزوره* ↓\n {'..name..'}')return falseendend------------------------------------------------------------------------if text == ''..(database:get(bot_id..'Klam:Hzor'..msg.chat_id_) or '')..'' and not database:get(bot_id..'Set:Hzora'..msg.chat_id_) thenif not database:get(bot_id..'Set:Hzora'..msg.chat_id_) then send(msg.chat_id_, msg.id_,' *✺↜ الف مبروك لقد فزت* \n *✺↜ للعب مره اخره ارسل »{ حزوره }*')database:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1) enddatabase:set(bot_id..'Set:Hzora'..msg.chat_id_,true)end
...
local Teext =[[
*‹ : ﺂه‍ـلا بـﯾك ؏ـزيزي في ﺂواﻤࢪ الحمايه :  ›*
*┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*
*‹ : اواﻤر قفل + فتح*
...
{{text = '۾𝟭', callback_data="/help1"},{text = '۾𝟮', callback_data="/help2"}},
            {{text = '۾𝟯', callback_data="/help3"}},
   {{text = '‹  ﺂلالـ؏ـاب  ›', callback_data="/help4"},{text = '‹  ﺂلتسلـﯾـه  ›', callback_data="/help5"}},
            {{text = '‹  ﺂوامࢪ الا؏ـضاء  ›', callback_data="/help6"}},
}
...
local Teext =[[
*‹ : ﺂه‍ـلا بـﯾك ؏ـزيزي فـﻲ قسـ۾ ﺂلـ؏ـاب .*
*┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*
...
local Teext =[[
*‹ : اه‍لا بـﯾك ؏ـزيزي في اوامࢪ الاعضاء .*
*┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*
*‹ : السوࢪس , ࢪتبتي , معلوماتي .*
*‹ : ࢪقمي , لقبي , نبذتي , صلاحياتي , غنيلي .*
*‹ : تحويل الصيغ بالࢪد ❨ صوࢪه,متحࢪڪه,ملصق,بصمه ❩ .*
*‹ : ࢪسائلي , مسح ࢪسائلي , اسمي , معࢪفي . *
*‹ : ايدي , ايديي , جهاتي, ࢪاسلني , الالعاب .*
*‹ : نقاطي , بيع نقاطي , القوانين , زخࢪفه + الاسم .*
*‹ : ࢪابط الحذف , نزلني , اطࢪدني , المطوࢪ .*
*‹ : منو ضافني , الࢪابط , صيحه , هينه .*
*‹ : ايدي المجموعه , معلومات المجموعه , عدد الڪࢪوب .*
*‹ : نسبه الحب , نسبه الڪࢪه , نسبه الغباء .*
*‹ : نسبه الࢪجوله , نسبه الانوثه , التفاعل , تفاعلي .*
*‹ : ڪت تويت , صࢪاحه .*
...
*‹ : بوسه , بوسها + بالرد .*
*‹ : احسب + تاريخ ميلادك .*
*‹ : صلاحياته❨ بالࢪد,بالمعرف,بالايدي ❩ .*
*‹ : ايدي , ڪشف  ❨ بالࢪد,بالمعࢪف,بالايدي ❩  .*
*┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*
[‹ ѕᴏụʀᴄᴇ : ᴡᴀᴀᴅ ›](t.me/nnnnBn)
]]
keyboard = {} 
